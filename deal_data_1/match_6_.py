...
def match_simu_detect(simulated_outcat_path, detected_outcat_path, match_save_path):
    ...
    while 1:
        ...
        # 确定误差项
        temp = np.array([Error_xyz, size_simu_i / 2.35])
...
if __name__ == '__main__':
    ...
    # for t in range(0, 40):
    #     simulated_outcat_path = r'/home/data/longc/pycharm/voxnet/simulate_data/simulate_100/3D_clump_100/outcat_record/gaussian_outcat_%04d.txt'%t
    #     detected_outcat_path = r'/home/data/longc/pycharm/voxnet/simulate_data/simulate_100/detect_dir3/%04d/outcat.csv'%t
    #     match_result=r'/home/data/longc/pycharm/voxnet/simulate_data/simulate_100/match_clumpfind3'
    #     match_simu_detect(simulated_outcat_path, detected_outcat_path, match_result)
    # #
    # #
    # #
    # for t in range(0, 15):
    #     simulated_outcat_path = r'/home/data/longc/pycharm/voxnet/simulate_data/test_100/3D_clump_100/outcat_record/gaussian_outcat_%04d.txt'%t
    #     detected_outcat_path = r'/home/data/longc/pycharm/voxnet/simulate_data/test_100/match_clumpfind3/detect/%04d/outcat.csv'%t
    #     match_result=r'/home/data/longc/pycharm/voxnet/simulate_data/test_100/match_clumpfind3'
    #     match_simu_detect(simulated_outcat_path, detected_outcat_path, match_result)
